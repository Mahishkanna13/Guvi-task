...
$stmt->execute();
  ...
  echo "<h2> <center>Click <button style=\"background:#c14949;color:white;padding:5px\";><a style=\"color:white\"; href=\"http://localhost/MAHISHKANNA//login.html\">here</a></button> to Sign in </center></h2>";
